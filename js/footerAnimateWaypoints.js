...
//footer animations
		                jQuery('#TKfootercontent .footer-anim-0').css({'opacity':'0'});
			        ...
			        jQuery('#TKfootercontent .footer-anim-1').css({'opacity':'0'});
			        ...
			        jQuery('#TKfootercontent .footer-anim-2').css({'opacity':'0'});
			        ...
			        jQuery('#TKfootercontent .footer-anim-3').css({'opacity':'0'});
...
jQuery('#TKcontent .top-anim-0').css({'opacity':'0'});
...
jQuery('#TKcontent .top-anim-1').css({'opacity':'0'});
...
jQuery('#TKcontent .top-anim-2').css({'opacity':'0'});
...
jQuery('#TKcontent .top-anim-3').css({'opacity':'0'});
